...
type ComboboxListProps<Item> = Omit<ComboboxPrimitive.List.Props, "children"> & {
  children?: React.ReactNode | ((item: Item, index: number) => React.ReactNode)
}

function ComboboxList<Item = unknown>({
  className,
  ...props
}: ComboboxListProps<Item>) {
  return (
...
type ComboboxItemProps<Value> = Omit<ComboboxPrimitive.Item.Props, "value"> & {
  value?: Value
}

function ComboboxItem<Value = unknown>({
  className,
  children,
  ...props
...
type ComboboxGroupProps<Item> = Omit<ComboboxPrimitive.Group.Props, "items"> & {
  items?: readonly Item[] | undefined
}

function ComboboxGroup<Item = unknown>({
  className,
  ...props
}: ComboboxGroupProps<Item>) {
  return (
...
type ComboboxCollectionProps<Item> = Omit<
...
function ComboboxCollection<Item = unknown>({
  ...props
}: ComboboxCollectionProps<Item>) {
  return (
